...
loadImage: does [
	...
	if not none? tmp [
		...
		rcvSobel mat1 mat2 img1/size 1 1	; Sobel convolution x
		rcvSobel mat1 mat3 img1/size 2 1	; Sobel convolution y
		rcvSobel mat1 mat4 img1/size 3 1	; Sobel convolution x and y
