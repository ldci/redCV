...
split: does [
	if isFile [
		t1: now/time/precise
		b: rcvSplit2Mat img1 bitSize				;--split image into 4 matrices
		mat0: b/1									;--get r channel 
		mat1: b/2									;--get g channel
		mat2: b/3									;--get b channel
		mat3: b/4									;--get alpha channel
		rcvMat2Image mat1 imgC1						;--make a 3 channels image from r matrice
		rcvMat2Image mat2 imgC2 					;--make a 3 channels image from g matrice					
		rcvMat2Image mat3 imgC3 					;--make a 3 channels image from b matrice 
