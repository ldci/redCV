...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_ctx||292~encode: "f_ctx||292~encode" [octx [pointer! [integer!]]] 
            f_ctx||292~decode: "f_ctx||292~decode" [octx [pointer! [integer!]]] 
            f_ctx||301~to-csv-line: "f_ctx||301~to-csv-line" [octx [pointer! [integer!]]] 
            f_ctx||301~escape-value: "f_ctx||301~escape-value" [octx [pointer! [integer!]]] 
            f_ctx||301~next-column-name: "f_ctx||301~next-column-name" [octx [pointer! [integer!]]] 
            f_ctx||301~make-header: "f_ctx||301~make-header" [octx [pointer! [integer!]]] 
            f_ctx||301~get-columns: "f_ctx||301~get-columns" [octx [pointer! [integer!]]] 
            f_ctx||301~encode-map: "f_ctx||301~encode-map" [octx [pointer! [integer!]]] 
            f_ctx||301~encode-maps: "f_ctx||301~encode-maps" [octx [pointer! [integer!]]] 
            f_ctx||301~encode-flat: "f_ctx||301~encode-flat" [octx [pointer! [integer!]]] 
            f_ctx||301~encode-blocks: "f_ctx||301~encode-blocks" [octx [pointer! [integer!]]] 
            f_load-csv: "f_load-csv" [octx [pointer! [integer!]]] 
            f_to-csv: "f_to-csv" [octx [pointer! [integer!]]] 
            f_ctx||314~on-change*: "f_ctx||314~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||317~on-change*: "f_ctx||317~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||317~on-deep-change*: "f_ctx||317~on-deep-change*" [octx [pointer! [integer!]]] 
            f_reactor: "f_reactor" [] 
            f_deep-reactor: "f_deep-reactor" [] 
            f_ctx||322~add-relation: "f_ctx||322~add-relation" [octx [pointer! [integer!]]] 
            f_ctx||322~eval: "f_ctx||322~eval" [octx [pointer! [integer!]]] 
            f_ctx||322~eval-reaction: "f_ctx||322~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx||322~pending?: "f_ctx||322~pending?" [octx [pointer! [integer!]]] 
            f_ctx||322~check: "f_ctx||322~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx||322~is~: "f_ctx||322~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_register-scheme: "f_register-scheme" [] 
            f_ctx||336~alpha-num+: "f_ctx||336~alpha-num+" [octx [pointer! [integer!]]] 
            f_ctx||336~parse-url: "f_ctx||336~parse-url" [octx [pointer! [integer!]]] 
            f_decode-url: "f_decode-url" [octx [pointer! [integer!]]] 
            f_encode-url: "f_encode-url" [octx [pointer! [integer!]]] 
            f_ctx||342~do-quit: "f_ctx||342~do-quit" [octx [pointer! [integer!]]] 
            f_ctx||342~throw-error: "f_ctx||342~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||342~syntax-error: "f_ctx||342~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx||342~do-safe: "f_ctx||342~do-safe" [octx [pointer! [integer!]]] 
            f_ctx||342~do-code: "f_ctx||342~do-code" [octx [pointer! [integer!]]] 
            f_ctx||342~count-args: "f_ctx||342~count-args" [octx [pointer! [integer!]]] 
            f_ctx||342~func-arity?: "f_ctx||342~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx||342~fetch-next: "f_ctx||342~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx||342~eval: "f_ctx||342~eval" [octx [pointer! [integer!]]] 
            f_ctx||342~do-macro: "f_ctx||342~do-macro" [octx [pointer! [integer!]]] 
            f_ctx||342~register-macro: "f_ctx||342~register-macro" [octx [pointer! [integer!]]] 
            f_ctx||342~reset: "f_ctx||342~reset" [octx [pointer! [integer!]]] 
            f_ctx||342~expand: "f_ctx||342~expand" [octx [pointer! [integer!]]] 
            ...
            f_ctx||369~tail-idx?: "f_ctx||369~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx||369~push-color: "f_ctx||369~push-color" [octx [pointer! [integer!]]] 
            f_ctx||369~pop-color: "f_ctx||369~pop-color" [octx [pointer! [integer!]]] 
            f_ctx||369~close-colors: "f_ctx||369~close-colors" [octx [pointer! [integer!]]] 
            f_ctx||369~push: "f_ctx||369~push" [octx [pointer! [integer!]]] 
            f_ctx||369~pop: "f_ctx||369~pop" [octx [pointer! [integer!]]] 
            f_ctx||369~pop-all: "f_ctx||369~pop-all" [octx [pointer! [integer!]]] 
            f_ctx||369~optimize: "f_ctx||369~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx||367~line-height?: "f_ctx||367~line-height?" [octx [pointer! [integer!]]] 
            f_ctx||367~line-count?: "f_ctx||367~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx||389~on-change*: "f_ctx||389~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||389~on-deep-change*: "f_ctx||389~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||393~on-change*: "f_ctx||393~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||393~on-deep-change*: "f_ctx||393~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||397~on-change*: "f_ctx||397~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||400~on-change*: "f_ctx||400~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||403~capture-events: "f_ctx||403~capture-events" [octx [pointer! [integer!]]] 
            f_ctx||403~awake: "f_ctx||403~awake" [octx [pointer! [integer!]]] 
            f_ctx||411~init: "f_ctx||411~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx||419~title-ize: "f_ctx||419~title-ize" [octx [pointer! [integer!]]] 
            f_ctx||419~sentence-ize: "f_ctx||419~sentence-ize" [octx [pointer! [integer!]]] 
            f_ctx||419~capitalize: "f_ctx||419~capitalize" [octx [pointer! [integer!]]] 
            f_ctx||419~adjust-buttons: "f_ctx||419~adjust-buttons" [octx [pointer! [integer!]]] 
            f_ctx||419~Cancel-OK: "f_ctx||419~Cancel-OK" [octx [pointer! [integer!]]] 
            f_ctx||417~process: "f_ctx||417~process" [octx [pointer! [integer!]]] 
            f_ctx||415~throw-error: "f_ctx||415~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||415~process-reactors: "f_ctx||415~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx||415~calc-size: "f_ctx||415~calc-size" [octx [pointer! [integer!]]] 
            f_ctx||415~align-faces: "f_ctx||415~align-faces" [octx [pointer! [integer!]]] 
            f_ctx||415~resize-child-panels: "f_ctx||415~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx||415~clean-style: "f_ctx||415~clean-style" [octx [pointer! [integer!]]] 
            f_ctx||415~process-draw: "f_ctx||415~process-draw" [octx [pointer! [integer!]]] 
            f_ctx||415~pre-load: "f_ctx||415~pre-load" [octx [pointer! [integer!]]] 
            f_ctx||415~add-option: "f_ctx||415~add-option" [octx [pointer! [integer!]]] 
            f_ctx||415~add-flag: "f_ctx||415~add-flag" [octx [pointer! [integer!]]] 
            f_ctx||415~fetch-value: "f_ctx||415~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx||415~fetch-argument: "f_ctx||415~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx||415~fetch-expr: "f_ctx||415~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx||415~fetch-options: "f_ctx||415~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx||415~make-actor: "f_ctx||415~make-actor" [octx [pointer! [integer!]]] 
            ...
            ctx||280~encode: "ctx||280~encode" [img [red-image!] where [cell!]] 
            ctx||280~decode: "ctx||280~decode" [data [cell!]] 
            ctx||283~encode: "ctx||283~encode" [img [red-image!] where [cell!]] 
            ctx||283~decode: "ctx||283~decode" [data [cell!]] 
            ctx||286~encode: "ctx||286~encode" [img [red-image!] where [cell!]] 
            ctx||286~decode: "ctx||286~decode" [data [cell!]] 
            ctx||289~encode: "ctx||289~encode" [img [red-image!] where [cell!]] 
            ctx||289~decode: "ctx||289~decode" [data [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx||411~make-null-handle: "ctx||411~make-null-handle" [] 
            ctx||411~get-screen-size: "ctx||411~get-screen-size" [id [integer!]] 
            ctx||411~size-text: "ctx||411~size-text" [face [red-object!] value [cell!]] 
            ctx||411~on-change-facet: "ctx||411~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx||411~update-font: "ctx||411~update-font" [font [red-object!] flags [integer!]] 
            ctx||411~update-para: "ctx||411~update-para" [face [red-object!] flags [integer!]] 
            ctx||411~destroy-view: "ctx||411~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx||411~update-view: "ctx||411~update-view" [face [red-object!]] 
            ctx||411~refresh-window: "ctx||411~refresh-window" [h [red-handle!]] 
            ctx||411~redraw: "ctx||411~redraw" [face [red-object!]] 
            ctx||411~show-window: "ctx||411~show-window" [id [red-handle!]] 
            ctx||411~make-view: "ctx||411~make-view" [face [red-object!] parent [red-handle!]] 
            ctx||411~draw-image: "ctx||411~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx||411~draw-face: "ctx||411~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx||411~do-event-loop: "ctx||411~do-event-loop" [no-wait? [logic!]] 
            ctx||411~exit-event-loop: "ctx||411~exit-event-loop" [] 
            ctx||411~request-font: "ctx||411~request-font" [font [red-object!] selected [red-object!] mono? [logic!]] 
            ctx||411~request-file: "ctx||411~request-file" [title [red-string!] name [red-file!] filter [red-block!] save? [logic!] multi? [logic!]] 
            ctx||411~request-dir: "ctx||411~request-dir" [title [red-string!] dir [red-file!] filter [red-block!] keep? [logic!] multi? [logic!]] 
            ctx||411~text-box-metrics: "ctx||411~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx||411~update-scroller: "ctx||411~update-scroller" [scroller [red-object!] flags [integer!]] 
    ...
    binary: context [
        #import [libRedRT-file stdcall [
                ...
                load: "red/binary/load" [src [pointer! [byte!]] size [integer!] return: [red-binary!]] 
                rs-abs-at: "red/binary/rs-abs-at" [bin [red-binary!] pos [integer!] return: [integer!]]
            ]]
    ] 
    block: context [
        #import [libRedRT-file stdcall [
    ...
    word: context [
        #import [libRedRT-file stdcall [
                ...
                load-in: "red/word/load-in" [str [c-string!] blk [red-block!] return: [red-word!]]
            ]]
    ] 
    _context: context [
        #import [libRedRT-file stdcall [
    ...
    ownership: context [
        #import [libRedRT-file stdcall [
                ...
                check: "red/ownership/check" [value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]]
            ]]
    ] 
    collector: context [
        #import [libRedRT-file stdcall [
