[[
        ...
        ** [op! 2 [{Returns a number raised to a given power (exponent)} number [number!] "Base value" exponent [integer! float!] "The power (index) to raise the base value by" return: [number!]] #[none]] 
        ...
        ctx290~eval-reaction [function! 3 [reactor [object!] reaction [block! function!] target /mark] [/mark 1 0]] 
        ctx290~pending? [function! 2 [reactor [object!] reaction [block! function!] 
                /local q
            ] #[none]] 
        ...
        ctx371~update-font [routine! 2 [font #[block![2 2264x1 red-object!]3] flags #[block![2 2264x1 integer!]3]] #[none]] 
        ctx371~update-para [routine! 2 [face #[block![2 2264x1 red-object!]3] flags #[block![2 2264x1 integer!]3]] #[none]] 
        ctx371~destroy-view [routine! 2 [face #[block![2 2264x1 red-object!]3] empty? #[block![2 2264x1 logic!]3]] #[none]] 
        ctx371~update-view [routine! 1 [face #[block![2 2264x1 red-object!]3]] #[none]] 
        ctx371~refresh-window [routine! 1 [h #[block![2 2264x1 red-handle!]3]] #[none]] 
        ctx371~redraw [routine! 1 [face #[block![2 2264x1 red-object!]3] /local h #[block![2 2264x1 integer!]3]] #[none]] 
        ctx371~show-window [routine! 1 [id #[block![2 2264x1 red-handle!]3]] #[none]] 
        ctx371~make-view [routine! 2 [face #[block![2 2264x1 red-object!]3] parent #[block![2 2264x1 red-handle!]3]] #[none]] 
        ctx371~draw-image [routine! 2 [image #[block![2 2264x1 red-image!]3] cmds #[block![2 2264x1 red-block!]3]] #[none]] 
        ctx371~draw-face [routine! 2 [face #[block![2 2264x1 red-object!]3] cmds #[block![2 2264x1 red-block!]3] /local int #[block![2 2264x1 red-integer!]3]] #[none]] 
        ctx371~do-event-loop [routine! 1 [no-wait? #[block![2 2264x1 logic!]3] /local bool #[block![2 2264x1 red-logic!]3]] #[none]] 
        ctx371~exit-event-loop [routine! 0 [] #[none]] 
        ctx371~request-font [routine! 3 [font #[block![2 2264x1 red-object!]3] selected #[block![2 2264x1 red-object!]3] mono? #[block![2 2264x1 logic!]3]] #[none]] 
        ...
        ctx371~update-scroller [routine! 2 [scroller #[block![2 2264x1 red-object!]3] flags #[block![2 2264x1 integer!]3]] #[none]] 
        ...
        scroller! #[object! [
            ...
            check 
            is~
        ] ctx292 [code safe local result] ctx293 [reactor reaction target mark] ctx294 [reactor reaction local q] ctx295 [reactor only field local pos reaction q q'] ctx296 [
            face 
            ...
            pop-all 
            optimize
        ] ctx331 [] ctx332 [c] ctx333 [local entry pos] ctx334 [local pos] ctx335 [style] ctx336 [style local entry type] ctx337 [mark local first? i] ctx338 [local cur pos range pos1 e s l mov] ctx339 [
            spec 
            only 
            with 
            face
        ...
        ctx331: get-root-node2 954 
        ctx332: get-root-node2 957 
        ...
        ctx344: get-root-node2 995 
        ctx345: get-root-node2 998 
        ctx346: get-root-node2 1001 
        ctx347: get-root-node2 1004 
        ctx348: get-root-node2 1007 
        ctx349: get-root-node2 1010 
        ctx351: get-root-node2 1011 
        ctx352: get-root-node2 1014 
        evt350: as node! 0 
        ctx353: get-root-node2 1017 
        ctx355: get-root-node2 1018 
        ctx356: get-root-node2 1021 
        evt354: as node! 0 
        ctx357: get-root-node2 1024 
        ctx359: get-root-node2 1025 
        evt358: as node! 0 
        ctx360: get-root-node2 1028 
        ctx362: get-root-node2 1029 
        evt361: as node! 0 
        ctx363: get-root-node2 1032 
        ctx365: get-root-node2 1033 
        ctx367: get-root-node2 1034 
        ctx369: get-root-node2 1036 
        ctx370: get-root-node2 1039 
        ctx371: get-root-node2 1042 
        ctx373: get-root-node2 1085 
        ctx374: get-root-node2 1089 
        ctx375: get-root-node2 1092 
        ctx377: get-root-node2 1094 
        ctx379: get-root-node2 1095 
        ctx381: get-root-node2 1099 
        ctx382: get-root-node2 1102 
        ctx383: get-root-node2 1105 
        ctx384: get-root-node2 1108 
        ctx385: get-root-node2 1111 
        ctx386: get-root-node2 1117 
        ctx387: get-root-node2 1122 
        ctx389: get-root-node2 1123 
        ctx390: get-root-node2 1126 
        ...
        ctx438: get-root-node2 1289 
        ctx463: get-root-node2 1497
    ] 468 [%modules/view/view.red] [f_routine #[object! [
            spec: #[none]
            body: #[none]
        ...
        ["Returns true if the value is this type" value [any-type!]] f_any-list? #[object! [
            ...
            target: #[none]
            mark: #[none]
        ]] ctx293 [reactor [object!] reaction [block! function!] target /mark] f_ctx290~pending? #[object! [
            reactor: #[none]
            reaction: #[none]
            local: #[none]
            q: #[none]
        ]] ctx294 [reactor [object!] reaction [block! function!] 
            /local q
