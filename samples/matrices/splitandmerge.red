...
img1: rcvLoadImage %../../images/baboon.jpg	; load image
imgC1: rcvCreateImage img1/size				; create image for rgb
imgC2: rcvCreateImage img1/size
imgC3: rcvCreateImage img1/size
imgD: rcvCreateImage img1/size				; and destination image

mat0: rcvCreateMat 'integer! 8 img1/size	; create all matrices we need for argb
...
rcvMat82Image mat1 imgC1
rcvMat82Image mat2 imgC2
rcvMat82Image mat3 imgC3
