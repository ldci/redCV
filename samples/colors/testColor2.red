...
view win: layout [
	...
	return
	button 256 "Generate image 1" [img1: rcvRandomImage/uniform img1/size 255.255.255 
									color1: rcvGetPixel img1 127x127
									f1/text: form color1
									bb1/image: img1 
								]
	button 256 "Generate image 2" [img2: rcvRandomImage/uniform img1/size 255.255.255 
									color2: rcvGetPixel img2 127x127
									f2/text: form color2
									bb2/image: img2
									]
