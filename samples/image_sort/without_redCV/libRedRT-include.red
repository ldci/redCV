...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_average: "f_average" [] 
            f_last?: "f_last?" [] 
            f_ctx210~platform: "f_ctx210~platform" [octx [pointer! [integer!]]] 
            f_ctx239~interpreted?: "f_ctx239~interpreted?" [octx [pointer! [integer!]]] 
            f_ctx250~on-change*: "f_ctx250~on-change*" [octx [pointer! [integer!]]] 
            f_ctx248~on-change*: "f_ctx248~on-change*" [octx [pointer! [integer!]]] 
            f_ctx248~on-deep-change*: "f_ctx248~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx265~throw-error: "f_ctx265~throw-error" [octx [pointer! [integer!]]] 
            f_ctx265~make-time: "f_ctx265~make-time" [octx [pointer! [integer!]]] 
            f_ctx265~to-word: "f_ctx265~to-word" [octx [pointer! [integer!]]] 
            f_ctx265~pop: "f_ctx265~pop" [octx [pointer! [integer!]]] 
            f_ctx265~store: "f_ctx265~store" [octx [pointer! [integer!]]] 
            f_ctx265~transcode: "f_ctx265~transcode" [octx [pointer! [integer!]]] 
            f_ctx285~on-change*: "f_ctx285~on-change*" [octx [pointer! [integer!]]] 
            f_ctx288~on-change*: "f_ctx288~on-change*" [octx [pointer! [integer!]]] 
            f_ctx288~on-deep-change*: "f_ctx288~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx291~add-relation: "f_ctx291~add-relation" [octx [pointer! [integer!]]] 
            f_ctx291~eval: "f_ctx291~eval" [octx [pointer! [integer!]]] 
            f_ctx291~eval-reaction: "f_ctx291~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx291~pending?: "f_ctx291~pending?" [octx [pointer! [integer!]]] 
            f_ctx291~check: "f_ctx291~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx291~is~: "f_ctx291~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_ctx304~do-quit: "f_ctx304~do-quit" [octx [pointer! [integer!]]] 
            f_ctx304~throw-error: "f_ctx304~throw-error" [octx [pointer! [integer!]]] 
            f_ctx304~syntax-error: "f_ctx304~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx304~do-safe: "f_ctx304~do-safe" [octx [pointer! [integer!]]] 
            f_ctx304~do-code: "f_ctx304~do-code" [octx [pointer! [integer!]]] 
            f_ctx304~count-args: "f_ctx304~count-args" [octx [pointer! [integer!]]] 
            f_ctx304~func-arity?: "f_ctx304~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx304~fetch-next: "f_ctx304~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx304~eval: "f_ctx304~eval" [octx [pointer! [integer!]]] 
            f_ctx304~do-macro: "f_ctx304~do-macro" [octx [pointer! [integer!]]] 
            f_ctx304~register-macro: "f_ctx304~register-macro" [octx [pointer! [integer!]]] 
            f_ctx304~reset: "f_ctx304~reset" [octx [pointer! [integer!]]] 
            f_ctx304~expand: "f_ctx304~expand" [octx [pointer! [integer!]]] 
            ...
            f_ctx331~tail-idx?: "f_ctx331~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx331~push-color: "f_ctx331~push-color" [octx [pointer! [integer!]]] 
            f_ctx331~pop-color: "f_ctx331~pop-color" [octx [pointer! [integer!]]] 
            f_ctx331~close-colors: "f_ctx331~close-colors" [octx [pointer! [integer!]]] 
            f_ctx331~push: "f_ctx331~push" [octx [pointer! [integer!]]] 
            f_ctx331~pop: "f_ctx331~pop" [octx [pointer! [integer!]]] 
            f_ctx331~pop-all: "f_ctx331~pop-all" [octx [pointer! [integer!]]] 
            f_ctx331~optimize: "f_ctx331~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx329~line-height?: "f_ctx329~line-height?" [octx [pointer! [integer!]]] 
            f_ctx329~line-count?: "f_ctx329~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx351~on-change*: "f_ctx351~on-change*" [octx [pointer! [integer!]]] 
            f_ctx351~on-deep-change*: "f_ctx351~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx355~on-change*: "f_ctx355~on-change*" [octx [pointer! [integer!]]] 
            f_ctx355~on-deep-change*: "f_ctx355~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx359~on-change*: "f_ctx359~on-change*" [octx [pointer! [integer!]]] 
            f_ctx362~on-change*: "f_ctx362~on-change*" [octx [pointer! [integer!]]] 
            f_ctx365~capture-events: "f_ctx365~capture-events" [octx [pointer! [integer!]]] 
            f_ctx365~awake: "f_ctx365~awake" [octx [pointer! [integer!]]] 
            f_ctx373~init: "f_ctx373~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx381~title-ize: "f_ctx381~title-ize" [octx [pointer! [integer!]]] 
            f_ctx381~sentence-ize: "f_ctx381~sentence-ize" [octx [pointer! [integer!]]] 
            f_ctx381~capitalize: "f_ctx381~capitalize" [octx [pointer! [integer!]]] 
            f_ctx381~adjust-buttons: "f_ctx381~adjust-buttons" [octx [pointer! [integer!]]] 
            f_ctx381~Cancel-OK: "f_ctx381~Cancel-OK" [octx [pointer! [integer!]]] 
            f_ctx379~process: "f_ctx379~process" [octx [pointer! [integer!]]] 
            f_ctx377~throw-error: "f_ctx377~throw-error" [octx [pointer! [integer!]]] 
            f_ctx377~process-reactors: "f_ctx377~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx377~calc-size: "f_ctx377~calc-size" [octx [pointer! [integer!]]] 
            f_ctx377~align-faces: "f_ctx377~align-faces" [octx [pointer! [integer!]]] 
            f_ctx377~resize-child-panels: "f_ctx377~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx377~clean-style: "f_ctx377~clean-style" [octx [pointer! [integer!]]] 
            f_ctx377~process-draw: "f_ctx377~process-draw" [octx [pointer! [integer!]]] 
            f_ctx377~pre-load: "f_ctx377~pre-load" [octx [pointer! [integer!]]] 
            f_ctx377~add-option: "f_ctx377~add-option" [octx [pointer! [integer!]]] 
            f_ctx377~add-flag: "f_ctx377~add-flag" [octx [pointer! [integer!]]] 
            f_ctx377~fetch-value: "f_ctx377~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx377~fetch-argument: "f_ctx377~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx377~fetch-expr: "f_ctx377~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx377~fetch-options: "f_ctx377~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx377~make-actor: "f_ctx377~make-actor" [octx [pointer! [integer!]]] 
            ...
            ctx265~make-hm: "ctx265~make-hm" [h [integer!] m [integer!]] 
            ctx265~make-msf: "ctx265~make-msf" [m [integer!] s [float!]] 
            ctx265~make-hms: "ctx265~make-hms" [h [integer!] m [integer!] s [integer!]] 
            ctx265~make-hmsf: "ctx265~make-hmsf" [h [integer!] m [integer!] s [float!]] 
            ctx265~make-binary: "ctx265~make-binary" [start [red-string!] end [red-string!] base [integer!]] 
            ctx265~make-tuple: "ctx265~make-tuple" [start [red-string!] end [red-string!]] 
            ctx265~make-number: "ctx265~make-number" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx265~make-float: "ctx265~make-float" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx265~make-hexa: "ctx265~make-hexa" [start [red-string!] end [red-string!] return: [integer!]] 
            ctx265~make-char: "ctx265~make-char" [start [red-string!] end [red-string!]] 
            ctx265~push-path: "ctx265~push-path" [stack [red-block!] type [red-datatype!]] 
            ctx265~set-path: "ctx265~set-path" [stack [red-block!]] 
            ctx265~make-word: "ctx265~make-word" [src [red-string!] type [red-datatype!]] 
            ctx265~new-line: "ctx265~new-line" [series [cell!]] 
            ctx273~encode: "ctx273~encode" [img [red-image!] where [cell!]] 
            ctx273~decode: "ctx273~decode" [data [cell!]] 
            ctx276~encode: "ctx276~encode" [img [red-image!] where [cell!]] 
            ctx276~decode: "ctx276~decode" [data [cell!]] 
            ctx279~encode: "ctx279~encode" [img [red-image!] where [cell!]] 
            ctx279~decode: "ctx279~decode" [data [cell!]] 
            ctx282~encode: "ctx282~encode" [img [red-image!] where [cell!]] 
            ctx282~decode: "ctx282~decode" [data [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx373~make-null-handle: "ctx373~make-null-handle" [] 
            ctx373~get-screen-size: "ctx373~get-screen-size" [id [integer!]] 
            ctx373~size-text: "ctx373~size-text" [face [red-object!] value [cell!]] 
            ctx373~on-change-facet: "ctx373~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx373~update-font: "ctx373~update-font" [font [red-object!] flags [integer!]] 
            ctx373~update-para: "ctx373~update-para" [face [red-object!] flags [integer!]] 
            ctx373~destroy-view: "ctx373~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx373~update-view: "ctx373~update-view" [face [red-object!]] 
            ctx373~refresh-window: "ctx373~refresh-window" [h [red-handle!]] 
            ctx373~redraw: "ctx373~redraw" [face [red-object!]] 
            ctx373~show-window: "ctx373~show-window" [id [red-handle!]] 
            ctx373~make-view: "ctx373~make-view" [face [red-object!] parent [red-handle!]] 
            ctx373~draw-image: "ctx373~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx373~draw-face: "ctx373~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx373~do-event-loop: "ctx373~do-event-loop" [no-wait? [logic!]] 
            ctx373~exit-event-loop: "ctx373~exit-event-loop" [] 
            ctx373~request-font: "ctx373~request-font" [font [red-object!] selected [red-object!] mono? [logic!]] 
            ctx373~request-file: "ctx373~request-file" [title [red-string!] name [red-file!] filter [red-block!] save? [logic!] multi? [logic!]] 
            ctx373~request-dir: "ctx373~request-dir" [title [red-string!] dir [red-file!] filter [red-block!] keep? [logic!] multi? [logic!]] 
            ctx373~text-box-metrics: "ctx373~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx373~update-scroller: "ctx373~update-scroller" [scroller [red-object!] flags [integer!]] 
    ...
    tuple: context [
        #import [libRedRT-file stdcall [
                ...
                random: "red/tuple/random" [tp [red-tuple!] seed? [logic!] secure? [logic!] only? [logic!] return: [cell!]]
            ]]
    ] 
    typeset: context [
        #import [libRedRT-file stdcall [
    ...
    _series: context [
        #import [libRedRT-file stdcall [
                ...
                remove: "red/_series/remove" [ser [red-series!] part-arg [cell!] return: [red-series!]]
            ]]
    ] 
    symbol: context [
        #import [libRedRT-file stdcall [
