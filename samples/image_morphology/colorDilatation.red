...
processMat: does [
	...
	mat4: b2/1 mat5: b2/2 mat6: b2/3 mat7: b2/4				; split image
	if r [rcvDilateMat mat1 mat5  5x5 knl]		; dilate r channel
	if g [rcvDilateMat mat2 mat6  5x5 knl]		; dilate g channel
	if b [rcvDilateMat mat3 mat7  5x5 knl]		; dilate b channel
