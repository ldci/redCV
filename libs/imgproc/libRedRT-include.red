...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_dt: "f_dt" [] 
            f_clock: "f_clock" [] 
            f_ctx||264~interpreted?: "f_ctx||264~interpreted?" [octx [pointer! [integer!]]] 
            f_ctx||267~on-change*: "f_ctx||267~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||274~on-change*: "f_ctx||274~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||274~on-deep-change*: "f_ctx||274~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||280~on-change*: "f_ctx||280~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||278~on-change*: "f_ctx||278~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||278~on-deep-change*: "f_ctx||278~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||308~tracer: "f_ctx||308~tracer" [octx [pointer! [integer!]]] 
            f_ctx||326~on-change*: "f_ctx||326~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||329~on-change*: "f_ctx||329~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||329~on-deep-change*: "f_ctx||329~on-deep-change*" [octx [pointer! [integer!]]] 
            f_reactor: "f_reactor" [] 
            f_deep-reactor: "f_deep-reactor" [] 
            f_ctx||335~add-relation: "f_ctx||335~add-relation" [octx [pointer! [integer!]]] 
            f_ctx||335~identify-sources: "f_ctx||335~identify-sources" [octx [pointer! [integer!]]] 
            f_ctx||335~eval: "f_ctx||335~eval" [octx [pointer! [integer!]]] 
            f_ctx||335~eval-reaction: "f_ctx||335~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx||335~pending?: "f_ctx||335~pending?" [octx [pointer! [integer!]]] 
            f_ctx||335~check: "f_ctx||335~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx||352~alpha-num+: "f_ctx||352~alpha-num+" [octx [pointer! [integer!]]] 
            f_ctx||352~parse-url: "f_ctx||352~parse-url" [octx [pointer! [integer!]]] 
            f_decode-url: "f_decode-url" [octx [pointer! [integer!]]] 
            f_encode-url: "f_encode-url" [octx [pointer! [integer!]]] 
            f_ctx||358~do-quit: "f_ctx||358~do-quit" [octx [pointer! [integer!]]] 
            f_ctx||358~throw-error: "f_ctx||358~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||358~syntax-error: "f_ctx||358~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx||358~do-safe: "f_ctx||358~do-safe" [octx [pointer! [integer!]]] 
            f_ctx||358~do-code: "f_ctx||358~do-code" [octx [pointer! [integer!]]] 
            f_ctx||358~rebind-all: "f_ctx||358~rebind-all" [octx [pointer! [integer!]]] 
            f_ctx||358~count-args: "f_ctx||358~count-args" [octx [pointer! [integer!]]] 
            f_ctx||358~arg-mode?: "f_ctx||358~arg-mode?" [octx [pointer! [integer!]]] 
            f_ctx||358~func-arity?: "f_ctx||358~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx||358~value-path?: "f_ctx||358~value-path?" [octx [pointer! [integer!]]] 
            f_ctx||358~fetch-next: "f_ctx||358~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx||358~eval: "f_ctx||358~eval" [octx [pointer! [integer!]]] 
            f_ctx||358~do-macro: "f_ctx||358~do-macro" [octx [pointer! [integer!]]] 
            f_ctx||358~register-macro: "f_ctx||358~register-macro" [octx [pointer! [integer!]]] 
            f_ctx||358~reset: "f_ctx||358~reset" [octx [pointer! [integer!]]] 
            f_ctx||358~expand: "f_ctx||358~expand" [octx [pointer! [integer!]]] 
            f_expand-directives: "f_expand-directives" [octx [pointer! [integer!]]] 
            f_ctx||377~calc-max: "f_ctx||377~calc-max" [octx [pointer! [integer!]]] 
            f_ctx||377~show-context: "f_ctx||377~show-context" [octx [pointer! [integer!]]] 
            f_ctx||377~show-parents: "f_ctx||377~show-parents" [octx [pointer! [integer!]]] 
            f_ctx||377~show-stack: "f_ctx||377~show-stack" [octx [pointer! [integer!]]] 
            f_ctx||377~show-watching: "f_ctx||377~show-watching" [octx [pointer! [integer!]]] 
            f_ctx||377~do-command: "f_ctx||377~do-command" [octx [pointer! [integer!]]] 
            f_ctx||377~debugger: "f_ctx||377~debugger" [octx [pointer! [integer!]]] 
            f_ctx||394~mold-part: "f_ctx||394~mold-part" [octx [pointer! [integer!]]] 
            f_ctx||394~dumper: "f_ctx||394~dumper" [octx [pointer! [integer!]]] 
            f_ctx||394~push: "f_ctx||394~push" [octx [pointer! [integer!]]] 
            f_ctx||394~drop: "f_ctx||394~drop" [octx [pointer! [integer!]]] 
            f_ctx||394~pop: "f_ctx||394~pop" [octx [pointer! [integer!]]] 
            f_ctx||394~top-of: "f_ctx||394~top-of" [octx [pointer! [integer!]]] 
            f_ctx||394~step: "f_ctx||394~step" [octx [pointer! [integer!]]] 
            f_ctx||403~put: "f_ctx||403~put" [octx [pointer! [integer!]]] 
            f_ctx||403~get: "f_ctx||403~get" [octx [pointer! [integer!]]] 
            f_ctx||407~save-level: "f_ctx||407~save-level" [octx [pointer! [integer!]]] 
            f_ctx||407~unroll-level: "f_ctx||407~unroll-level" [octx [pointer! [integer!]]] 
            f_ctx||407~reset: "f_ctx||407~reset" [octx [pointer! [integer!]]] 
            f_ctx||407~collector: "f_ctx||407~collector" [octx [pointer! [integer!]]] 
            f_ctx||394~guided-trace: "f_ctx||394~guided-trace" [octx [pointer! [integer!]]] 
            f_ctx||414~inspect: "f_ctx||414~inspect" [octx [pointer! [integer!]]] 
            f_ctx||377~profiler: "f_ctx||377~profiler" [octx [pointer! [integer!]]] 
            f_ctx||377~do-handler: "f_ctx||377~do-handler" [octx [pointer! [integer!]]] 
            ...
            f_ctx||433~tail-idx?: "f_ctx||433~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx||433~push-color: "f_ctx||433~push-color" [octx [pointer! [integer!]]] 
            f_ctx||433~pop-color: "f_ctx||433~pop-color" [octx [pointer! [integer!]]] 
            f_ctx||433~close-colors: "f_ctx||433~close-colors" [octx [pointer! [integer!]]] 
            f_ctx||433~push: "f_ctx||433~push" [octx [pointer! [integer!]]] 
            f_ctx||433~pop: "f_ctx||433~pop" [octx [pointer! [integer!]]] 
            f_ctx||433~pop-all: "f_ctx||433~pop-all" [octx [pointer! [integer!]]] 
            f_ctx||433~optimize: "f_ctx||433~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx||431~line-height?: "f_ctx||431~line-height?" [octx [pointer! [integer!]]] 
            f_ctx||431~line-count?: "f_ctx||431~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx||457~on-deep-change*: "f_ctx||457~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||461~on-change*: "f_ctx||461~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||464~on-change*: "f_ctx||464~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||467~capture-events: "f_ctx||467~capture-events" [octx [pointer! [integer!]]] 
            f_ctx||467~awake: "f_ctx||467~awake" [octx [pointer! [integer!]]] 
            f_ctx||475~init: "f_ctx||475~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx||483~color-backgrounds: "f_ctx||483~color-backgrounds" [octx [pointer! [integer!]]] 
            f_ctx||483~color-tabpanel-children: "f_ctx||483~color-tabpanel-children" [octx [pointer! [integer!]]] 
            f_ctx||483~OK-Cancel: "f_ctx||483~OK-Cancel" [octx [pointer! [integer!]]] 
            f_ctx||481~process: "f_ctx||481~process" [octx [pointer! [integer!]]] 
            f_ctx||479~throw-error: "f_ctx||479~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||479~process-reactors: "f_ctx||479~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx||479~opt-as-integer: "f_ctx||479~opt-as-integer" [octx [pointer! [integer!]]] 
            f_ctx||479~calc-size: "f_ctx||479~calc-size" [octx [pointer! [integer!]]] 
            f_ctx||479~align-faces: "f_ctx||479~align-faces" [octx [pointer! [integer!]]] 
            f_ctx||479~resize-child-panels: "f_ctx||479~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx||479~clean-style: "f_ctx||479~clean-style" [octx [pointer! [integer!]]] 
            f_ctx||479~process-draw: "f_ctx||479~process-draw" [octx [pointer! [integer!]]] 
            f_ctx||479~pre-load: "f_ctx||479~pre-load" [octx [pointer! [integer!]]] 
            f_ctx||479~preset-focus: "f_ctx||479~preset-focus" [octx [pointer! [integer!]]] 
            f_ctx||479~add-option: "f_ctx||479~add-option" [octx [pointer! [integer!]]] 
            f_ctx||479~add-flag: "f_ctx||479~add-flag" [octx [pointer! [integer!]]] 
            f_ctx||479~add-bounds: "f_ctx||479~add-bounds" [octx [pointer! [integer!]]] 
            f_ctx||479~fetch-value: "f_ctx||479~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx||479~fetch-argument: "f_ctx||479~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx||479~fetch-expr: "f_ctx||479~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx||479~fetch-options: "f_ctx||479~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx||479~make-actor: "f_ctx||479~make-actor" [octx [pointer! [integer!]]] 
            ...
            f_alert: "f_alert" [] 
            f_~anon532~: "f_~anon532~" [] 
            f_~anon534~: "f_~anon534~" [] 
            f_ctx||536~encode: "f_ctx||536~encode" [octx [pointer! [integer!]]] 
            f_ctx||536~decode: "f_ctx||536~decode" [octx [pointer! [integer!]]] 
            f_ctx||543~to-csv-line: "f_ctx||543~to-csv-line" [octx [pointer! [integer!]]] 
            f_ctx||543~escape-value: "f_ctx||543~escape-value" [octx [pointer! [integer!]]] 
            f_ctx||543~next-column-name: "f_ctx||543~next-column-name" [octx [pointer! [integer!]]] 
            f_ctx||543~make-header: "f_ctx||543~make-header" [octx [pointer! [integer!]]] 
            f_ctx||543~get-columns: "f_ctx||543~get-columns" [octx [pointer! [integer!]]] 
            f_ctx||543~encode-map: "f_ctx||543~encode-map" [octx [pointer! [integer!]]] 
            f_ctx||543~encode-maps: "f_ctx||543~encode-maps" [octx [pointer! [integer!]]] 
            f_ctx||543~encode-flat: "f_ctx||543~encode-flat" [octx [pointer! [integer!]]] 
            f_ctx||543~encode-blocks: "f_ctx||543~encode-blocks" [octx [pointer! [integer!]]] 
            f_load-csv: "f_load-csv" [octx [pointer! [integer!]]] 
            f_to-csv: "f_to-csv" [octx [pointer! [integer!]]] 
            f_ctx||556~decode-unicode-char: "f_ctx||556~decode-unicode-char" [octx [pointer! [integer!]]] 
            f_ctx||556~push: "f_ctx||556~push" [octx [pointer! [integer!]]] 
            f_ctx||556~pop: "f_ctx||556~pop" [octx [pointer! [integer!]]] 
            f_ctx||556~emit: "f_ctx||556~emit" [octx [pointer! [integer!]]] 
            f_load-json: "f_load-json" [octx [pointer! [integer!]]] 
            f_ctx||563~init-state: "f_ctx||563~init-state" [octx [pointer! [integer!]]] 
            f_ctx||563~emit-indent: "f_ctx||563~emit-indent" [octx [pointer! [integer!]]] 
            f_ctx||563~emit-key-value: "f_ctx||563~emit-key-value" [octx [pointer! [integer!]]] 
            f_ctx||563~red-to-json-value: "f_ctx||563~red-to-json-value" [octx [pointer! [integer!]]] 
            f_to-json: "f_to-json" [octx [pointer! [integer!]]] 
            f_ctx||570~encode: "f_ctx||570~encode" [octx [pointer! [integer!]]] 
            f_ctx||570~decode: "f_ctx||570~decode" [octx [pointer! [integer!]]] 
            f_keep: "f_keep" [] 
            ...
            ctx||311~encode: "ctx||311~encode" [img [red-image!] where [cell!]] 
            ctx||311~decode: "ctx||311~decode" [data [cell!]] 
            ctx||314~encode: "ctx||314~encode" [img [red-image!] where [cell!]] 
            ctx||314~decode: "ctx||314~decode" [data [cell!]] 
            ctx||317~encode: "ctx||317~encode" [img [red-image!] where [cell!]] 
            ctx||317~decode: "ctx||317~decode" [data [cell!]] 
            ctx||320~encode: "ctx||320~encode" [img [red-image!] where [cell!]] 
            ctx||320~decode: "ctx||320~decode" [data [cell!]] 
            ctx||323~encode: "ctx||323~encode" [data [cell!] where [cell!]] 
            ctx||323~decode: "ctx||323~decode" [payload [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx||475~make-null-handle: "ctx||475~make-null-handle" [] 
            ctx||475~get-screen-size: "ctx||475~get-screen-size" [id [integer!]] 
            ctx||475~size-text: "ctx||475~size-text" [face [red-object!] value [cell!]] 
            ctx||475~on-change-facet: "ctx||475~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx||475~update-font: "ctx||475~update-font" [font [red-object!] flags [integer!]] 
            ctx||475~update-para: "ctx||475~update-para" [face [red-object!] flags [integer!]] 
            ctx||475~destroy-view: "ctx||475~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx||475~update-view: "ctx||475~update-view" [face [red-object!]] 
            ctx||475~refresh-window: "ctx||475~refresh-window" [h [red-handle!]] 
            ctx||475~redraw: "ctx||475~redraw" [face [red-object!]] 
            ctx||475~show-window: "ctx||475~show-window" [id [red-handle!]] 
            ctx||475~make-view: "ctx||475~make-view" [face [red-object!] parent [red-handle!]] 
            ctx||475~draw-image: "ctx||475~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx||475~draw-face: "ctx||475~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx||475~do-event-loop: "ctx||475~do-event-loop" [no-wait? [logic!]] 
            ctx||475~exit-event-loop: "ctx||475~exit-event-loop" [] 
            ctx||475~request-font: "ctx||475~request-font" [font [red-object!] selected [cell!] mono? [logic!]] 
            ctx||475~request-file: "ctx||475~request-file" [title [cell!] name [cell!] filter [cell!] save? [logic!] multi? [logic!]] 
            ctx||475~request-dir: "ctx||475~request-dir" [title [cell!] dir [cell!] filter [cell!] keep? [logic!] multi? [logic!]] 
            ctx||475~text-box-metrics: "ctx||475~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx||475~update-scroller: "ctx||475~update-scroller" [scroller [red-object!] flags [integer!]] 
            ctx||475~set-dark-mode: "ctx||475~set-dark-mode" [face [red-object!] dark? [logic!]] 
            ctx||475~support-dark-mode?: "ctx||475~support-dark-mode?" [return: [logic!]] 
            ...
            ctx||556~unescape: "ctx||556~unescape" [str [red-string!] return: [red-string!]] 
            alloc-tail-unit: "red/alloc-tail-unit" [s [series-buffer!] unit [integer!] return: [pointer! [byte!]]] 
            f_time-it: "f_dt" [] 
            f_single?: "f_last?" [] 
            f_keys-of: "f_words-of" [] 
            f_object: "f_context" [] 
            f_halt: "f_quit" [] 
            f_ctx||394~emit: "red/natives/print*" [check? [logic!]] 
    ...
    float: context [
        #import [libRedRT-file stdcall [
                ...
                make-in: "red/float/make-in" [parent [red-block!] high [integer!] low [integer!] return: [red-float!]]
            ]]
    ] 
    _function: context [
        #import [libRedRT-file stdcall [
    ...
    pair: context [
        #import [libRedRT-file stdcall [
                ...
                make-in: "red/pair/make-in" [parent [red-block!] x [integer!] y [integer!] return: [red-pair!]]
            ]]
    ] 
    paren: context [
        #import [libRedRT-file stdcall [
    ...
    tuple: context [
        #import [libRedRT-file stdcall [
                ...
                rs-make: "red/tuple/rs-make" [[variadic] count [integer!] list [pointer! [integer!]] return: [red-tuple!]]
            ]]
    ] 
    typeset: context [
        #import [libRedRT-file stdcall [
    ...
    vector: context [
        #import [libRedRT-file stdcall [
                ...
                make-at: "red/vector/make-at" [slot [cell!] size [integer!] type [integer!] unit [integer!] return: [red-vector!]]
            ]]
    ] 
    word: context [
        #import [libRedRT-file stdcall [
    ...
    image: context [
        #import [libRedRT-file stdcall [
                ...
                delete: "red/image/delete" [img [red-image!]] 
                rs-pick: "red/image/rs-pick" [img [red-image!] offset [integer!] return: [red-tuple!]] 
                resize: "red/image/resize" [img [red-image!] width [integer!] height [integer!] return: [red-image!]]
            ]]
    ] 
    OS-image: context [
        #import [libRedRT-file stdcall [
    ...
    _random: context [
        #import [libRedRT-file stdcall [
                rand: "red/_random/rand" [return: [integer!]]
            ]]
    ] collector: context [
        #import [libRedRT-file stdcall [
