[[
        ...
        ** [op! 2 [{Returns a number raised to a given power (exponent)} number [number!] "Base value" exponent [integer! float!] "The power (index) to raise the base value by" return: [number!]] #[none]] 
        ...
        ctx||469~update-font [routine! 2 [font #[block![2 2461x1 red-object!]3] flags #[block![2 2461x1 integer!]3]] #[none]] 
        ctx||469~update-para [routine! 2 [face #[block![2 2461x1 red-object!]3] flags #[block![2 2461x1 integer!]3]] #[none]] 
        ctx||469~destroy-view [routine! 2 [face #[block![2 2461x1 red-object!]3] empty? #[block![2 2461x1 logic!]3]] #[none]] 
        ctx||469~update-view [routine! 1 [face #[block![2 2461x1 red-object!]3]] #[none]] 
        ctx||469~refresh-window [routine! 1 [h #[block![2 2461x1 red-handle!]3]] #[none]] 
        ctx||469~redraw [routine! 1 [face #[block![2 2461x1 red-object!]3] /local h #[block![2 2461x1 integer!]3]] #[none]] 
        ctx||469~show-window [routine! 1 [id #[block![2 2461x1 red-handle!]3]] #[none]] 
        ctx||469~make-view [routine! 2 [face #[block![2 2461x1 red-object!]3] parent #[block![2 2461x1 red-handle!]3]] #[none]] 
        ctx||469~draw-image [routine! 2 [image #[block![2 2461x1 red-image!]3] cmds #[block![2 2461x1 red-block!]3]] #[none]] 
        ctx||469~draw-face [routine! 2 [face #[block![2 2461x1 red-object!]3] cmds #[block![2 2461x1 red-block!]3] /local int #[block![2 2461x1 red-integer!]3]] #[none]] 
        ctx||469~do-event-loop [routine! 1 [no-wait? #[block![2 2461x1 logic!]3] /local bool #[block![2 2461x1 red-logic!]3]] #[none]] 
        ctx||469~exit-event-loop [routine! 0 [] #[none]] 
        ctx||469~request-font [routine! 3 [font #[block![2 2461x1 red-object!]3] selected #[block![2 2461x1 red-object!]3] mono? #[block![2 2461x1 logic!]3]] #[none]] 
        ...
        ctx||469~update-scroller [routine! 2 [scroller #[block![2 2461x1 red-object!]3] flags #[block![2 2461x1 integer!]3]] #[none]] 
        ...
        ctx||479~title-ize [function! 1 [text [string!] return: [string!] 
                /local p
            ] #[none]] 
        ctx||479~sentence-ize [function! 1 [text [string!] return: [string!] 
                /local h s e
            ] #[none]] 
        ctx||479~capitalize [function! 1 [
                {Capitalize widget text according to macOS guidelines} 
                root [object!] 
                /local rule pos
            ] #[none]] 
        ctx||479~adjust-buttons [function! 1 [
        ...
        scroller! #[object! [
            ...
            encode-flat: #[datatype! function!]
            encode-blocks: #[datatype! function!]
        ]] ctx||348 349 #[none] #[none] ctx||479 (red/objects/system/view/VID/GUI-rules/processors) ctx||479 480 #[none] #[none] ctx||487 (red/objects/system/view/VID/opts-proto) ctx||487 488 #[none] #[none]
        ...
        ] ctx||489 [spec] ctx||490 [local res 
            f blk later? ctx face
        ] ctx||491 [face local min-sz data txt s len mark e new] ctx||492 [pane dir align max-sz local edge? top-left? axis svmm face offset mar type] ctx||493 [tab local tp-size pad pane] ctx||494 [tmpl type local para font] ctx||495 [code local rule pos color] ctx||496 [value local color] ctx||497 [opts spec local field value] ctx||498 [obj facet field flag local blk] ctx||499 [blk local value] ctx||500 [expected pos local spec type value] ctx||501 [code] ctx||502 [
        ...
        ] ctx||503 [obj name body spec] ctx||504 [
            spec 
            tight 
            options 
            user-opts 
            ...
            win
        ] ctx||508 [] ctx||509 [code local result] ctx||510 [face event type local result 
            act name
        ] ctx||511 [
            face 
            with 
        ...
        ctx||244: get-root-node2 733 
        ctx||246: get-root-node2 738 
        ctx||248: get-root-node2 754 
        ctx||250: get-root-node2 756 
        ctx||252: get-root-node2 758 
        ctx||254: get-root-node2 761 
        ctx||256: get-root-node2 775 
        ctx||258: get-root-node2 776 
        ctx||259: get-root-node2 779 
        ctx||261: get-root-node2 780 
        ctx||263: get-root-node2 783 
        ctx||265: get-root-node2 785 
        ctx||266: get-root-node2 788 
        evt264: as node! 0 
        ctx||267: get-root-node2 791 
        ctx||269: get-root-node2 792 
        ctx||271: get-root-node2 793 
        evt270: as node! 0 
        ctx||272: get-root-node2 796 
        ctx||273: get-root-node2 799 
        evt268: as node! 0 
        ctx||274: get-root-node2 802 
        ctx||276: get-root-node2 803 
        ctx||278: get-root-node2 804 
        ctx||280: get-root-node2 805 
        ctx||282: get-root-node2 806 
        ctx||284: get-root-node2 807 
        ctx||286: get-root-node2 808 
        ctx||288: get-root-node2 809 
        ctx||290: get-root-node2 810 
        ctx||292: get-root-node2 811 
        ctx||294: get-root-node2 814 
        ctx||298: get-root-node2 822 
        ctx||302: get-root-node2 830 
        ctx||306: get-root-node2 838 
        ctx||310: get-root-node2 846 
        ctx||317: get-root-node2 850 
        ctx||318: get-root-node2 853 
        ctx||319: get-root-node2 856 
        ctx||321: get-root-node2 858 
        ctx||322: get-root-node2 861 
        ctx||323: get-root-node2 864 
        ctx||324: get-root-node2 867 
        ctx||325: get-root-node2 870 
        ctx||326: get-root-node2 873 
        ctx||327: get-root-node2 880 
        ctx||328: get-root-node2 883 
        ctx||329: get-root-node2 902 
        ctx||330: get-root-node2 905 
        ctx||331: get-root-node2 916 
        ctx||332: get-root-node2 919 
        ctx||333: get-root-node2 922 
        ctx||334: get-root-node2 925 
        ctx||335: get-root-node2 928 
        ctx||337: get-root-node2 930 
        ctx||338: get-root-node2 933 
        ctx||339: get-root-node2 936 
        ctx||340: get-root-node2 939 
        ctx||341: get-root-node2 942 
        ctx||343: get-root-node2 945 
        ctx||346: get-root-node2 949 
        ctx||347: get-root-node2 952 
        ctx||348: get-root-node2 955 
        ...
        ctx||360: get-root-node2 989 
        ctx||361: get-root-node2 992 
        ctx||363: get-root-node2 993 
        evt362: as node! 0 
        ctx||364: get-root-node2 996 
        ctx||366: get-root-node2 997 
        evt365: as node! 0 
        ctx||367: get-root-node2 1000 
        ctx||368: get-root-node2 1003 
        ctx||369: get-root-node2 1006 
        ...
        ctx||380: get-root-node2 1035 
        ctx||381: get-root-node2 1038 
        ctx||383: get-root-node2 1041 
        ctx||384: get-root-node2 1045 
        ctx||386: get-root-node2 1055 
        ...
        ctx||406: get-root-node2 1132 
        ctx||407: get-root-node2 1135 
        ctx||415: get-root-node2 1143 
        ctx||416: get-root-node2 1146 
        ctx||417: get-root-node2 1149 
        ctx||418: get-root-node2 1152 
        ctx||419: get-root-node2 1157 
        ctx||420: get-root-node2 1160 
        ctx||421: get-root-node2 1163 
        ctx||422: get-root-node2 1166 
        ctx||423: get-root-node2 1169 
        ctx||424: get-root-node2 1172 
        ctx||426: get-root-node2 1173 
        ...
        ctx||439: get-root-node2 1213 
        ctx||440: get-root-node2 1216 
        ctx||441: get-root-node2 1221 
        ctx||442: get-root-node2 1224 
        ctx||443: get-root-node2 1227 
        ctx||444: get-root-node2 1230 
        ctx||445: get-root-node2 1233 
        ctx||446: get-root-node2 1236 
        ctx||448: get-root-node2 1237 
        ctx||449: get-root-node2 1240 
        evt447: as node! 0 
        ctx||450: get-root-node2 1243 
        ctx||452: get-root-node2 1244 
        ctx||453: get-root-node2 1247 
        evt451: as node! 0 
        ctx||454: get-root-node2 1250 
        ctx||456: get-root-node2 1251 
        evt455: as node! 0 
        ctx||457: get-root-node2 1254 
        ctx||459: get-root-node2 1255 
        evt458: as node! 0 
        ctx||460: get-root-node2 1258 
        ctx||462: get-root-node2 1259 
        ctx||464: get-root-node2 1260 
        ctx||466: get-root-node2 1262 
        ctx||467: get-root-node2 1265 
        ctx||469: get-root-node2 1268 
        ctx||471: get-root-node2 1311 
        ctx||474: get-root-node2 1315 
        ctx||475: get-root-node2 1318 
        ctx||477: get-root-node2 1320 
        ctx||479: get-root-node2 1321 
        ctx||481: get-root-node2 1325 
        ctx||482: get-root-node2 1328 
        ctx||483: get-root-node2 1331 
        ctx||484: get-root-node2 1334 
        ctx||485: get-root-node2 1337 
        ctx||486: get-root-node2 1343 
        ctx||487: get-root-node2 1348 
        ...
        ctx||503: get-root-node2 1391 
        ctx||504: get-root-node2 1394 
        ...
        ctx||523: get-root-node2 1445 
        ctx||524: get-root-node2 1448 
        ctx||569: get-root-node2 1523 
        ctx||627: get-root-node2 1637 
        ctx||812: get-root-node2 1735
    ] 1177 [%modules/view/view.red] [f_routine #[object! [
            spec: #[none]
            body: #[none]
        ...
        ["Returns true if the value is this type" value [any-type!]] f_any-list? #[object! [
            ...
            /transparent "Make a transparent image, if pair! spec is used" 
            return: [image!]
        ] f_ctx||479~title-ize #[object! [
            text: #[none]
            local: #[none]
            p: #[none]
        ]] ctx||481 [text [string!] return: [string!] 
            /local p
        ] f_ctx||479~sentence-ize #[object! [
            text: #[none]
            local: #[none]
            h: #[none]
            s: #[none]
            e: #[none]
        ]] ctx||482 [text [string!] return: [string!] 
            /local h s e
        ] f_ctx||479~capitalize #[object! [
            root: #[none]
            local: #[none]
            rule: #[none]
            pos: #[none]
            ...
            root [object!] 
            /local rule pos
        ] f_ctx||479~adjust-buttons #[object! [
            root: #[none]
            local: #[none]
            def-margins: #[none]
            def-margin-yy: #[none]
            ...
            spec: #[none]
        ]] ctx||489 [spec [block!]] f_ctx||475~process-reactors #[object! [
            local: #[none]
            res: #[none]
            f: #[none]
            blk: #[none]
            ...
            mar: #[none]
            type: #[none]
        ]] ctx||492 [pane [block!] dir [word!] align [word!] max-sz [integer!] 
            /local edge? top-left? axis svmm face offset mar type
            ...
            para: #[none]
            font: #[none]
        ]] ctx||494 [tmpl [block!] type [word!] /local para font] f_ctx||475~process-draw #[object! [
            code: #[none]
            local: #[none]
            rule: #[none]
            pos: #[none]
            ...
            field: #[none]
            value: #[none]
        ]] ctx||497 [opts [object!] spec [block!] 
            /local field value
            ...
            local: #[none]
            blk: #[none]
        ]] ctx||498 [obj [object!] facet [word!] field [word!] flag return: [logic!] 
            /local blk
            ...
            type: #[none]
            value: #[none]
        ]] ctx||500 [expected [datatype! typeset!] 'pos [word!] 
            /local spec type value
        ] f_ctx||475~fetch-expr #[object! [
            code: #[none]
        ]] ctx||501 [code [word!]] f_ctx||475~fetch-options #[object! [
            face: #[none]
            opts: #[none]
            style: #[none]
            spec: #[none]
            ...
            body: #[none]
            spec: #[none]
        ]] ctx||503 [obj [object!] name [word!] body spec [block!]] f_layout #[object! [
            spec: #[none]
            tight: #[none]
            options: #[none]
            user-opts: #[none]
        ...
        ]] ctx||508 [] f_do-safe #[object! [
            code: #[none]
            local: #[none]
            result: #[none]
        ]] ctx||509 [code [block!] /local result] f_do-actor #[object! [
            face: #[none]
            event: #[none]
            type: #[none]
            local: #[none]
            ...
            act: #[none]
            name: #[none]
        ]] ctx||510 [face [object!] event [event! none!] type [word!] /local result 
            act name
        ] f_show #[object! [
            face: #[none]
            with: #[none]
