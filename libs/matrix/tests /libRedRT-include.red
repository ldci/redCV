...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_ctx||308~encode: "f_ctx||308~encode" [octx [pointer! [integer!]]] 
            f_ctx||308~decode: "f_ctx||308~decode" [octx [pointer! [integer!]]] 
            f_ctx||317~BOM-UTF-16?: "f_ctx||317~BOM-UTF-16?" [octx [pointer! [integer!]]] 
            f_ctx||317~BOM-UTF-32?: "f_ctx||317~BOM-UTF-32?" [octx [pointer! [integer!]]] 
            f_ctx||317~enquote: "f_ctx||317~enquote" [octx [pointer! [integer!]]] 
            f_ctx||317~high-surrogate?: "f_ctx||317~high-surrogate?" [octx [pointer! [integer!]]] 
            f_ctx||317~low-surrogate?: "f_ctx||317~low-surrogate?" [octx [pointer! [integer!]]] 
            f_ctx||317~translit: "f_ctx||317~translit" [octx [pointer! [integer!]]] 
            f_ctx||317~decode-backslash-escapes: "f_ctx||317~decode-backslash-escapes" [octx [pointer! [integer!]]] 
            f_ctx||317~encode-backslash-escapes: "f_ctx||317~encode-backslash-escapes" [octx [pointer! [integer!]]] 
            f_ctx||317~decode-unicode-char: "f_ctx||317~decode-unicode-char" [octx [pointer! [integer!]]] 
            f_ctx||317~replace-unicode-escapes: "f_ctx||317~replace-unicode-escapes" [octx [pointer! [integer!]]] 
            f_ctx||317~push: "f_ctx||317~push" [octx [pointer! [integer!]]] 
            f_ctx||317~pop: "f_ctx||317~pop" [octx [pointer! [integer!]]] 
            f_ctx||317~emit: "f_ctx||317~emit" [octx [pointer! [integer!]]] 
            f_load-json: "f_load-json" [octx [pointer! [integer!]]] 
            f_ctx||333~init-state: "f_ctx||333~init-state" [octx [pointer! [integer!]]] 
            f_ctx||333~emit-indent: "f_ctx||333~emit-indent" [octx [pointer! [integer!]]] 
            f_ctx||333~emit-key-value: "f_ctx||333~emit-key-value" [octx [pointer! [integer!]]] 
            f_ctx||333~red-to-json-value: "f_ctx||333~red-to-json-value" [octx [pointer! [integer!]]] 
            f_to-json: "f_to-json" [octx [pointer! [integer!]]] 
            f_ctx||341~encode: "f_ctx||341~encode" [octx [pointer! [integer!]]] 
            f_ctx||341~decode: "f_ctx||341~decode" [octx [pointer! [integer!]]] 
            f_ctx||346~to-csv-line: "f_ctx||346~to-csv-line" [octx [pointer! [integer!]]] 
            f_ctx||346~escape-value: "f_ctx||346~escape-value" [octx [pointer! [integer!]]] 
            f_ctx||346~next-column-name: "f_ctx||346~next-column-name" [octx [pointer! [integer!]]] 
            f_ctx||346~make-header: "f_ctx||346~make-header" [octx [pointer! [integer!]]] 
            f_ctx||346~get-columns: "f_ctx||346~get-columns" [octx [pointer! [integer!]]] 
            f_ctx||346~encode-map: "f_ctx||346~encode-map" [octx [pointer! [integer!]]] 
            f_ctx||346~encode-maps: "f_ctx||346~encode-maps" [octx [pointer! [integer!]]] 
            f_ctx||346~encode-flat: "f_ctx||346~encode-flat" [octx [pointer! [integer!]]] 
            f_ctx||346~encode-blocks: "f_ctx||346~encode-blocks" [octx [pointer! [integer!]]] 
            f_load-csv: "f_load-csv" [octx [pointer! [integer!]]] 
            f_to-csv: "f_to-csv" [octx [pointer! [integer!]]] 
            f_ctx||359~on-change*: "f_ctx||359~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||362~on-change*: "f_ctx||362~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||362~on-deep-change*: "f_ctx||362~on-deep-change*" [octx [pointer! [integer!]]] 
            f_reactor: "f_reactor" [] 
            f_deep-reactor: "f_deep-reactor" [] 
            f_ctx||367~add-relation: "f_ctx||367~add-relation" [octx [pointer! [integer!]]] 
            f_ctx||367~eval: "f_ctx||367~eval" [octx [pointer! [integer!]]] 
            f_ctx||367~eval-reaction: "f_ctx||367~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx||367~pending?: "f_ctx||367~pending?" [octx [pointer! [integer!]]] 
            f_ctx||367~check: "f_ctx||367~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx||367~is~: "f_ctx||367~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_register-scheme: "f_register-scheme" [] 
            f_ctx||382~alpha-num+: "f_ctx||382~alpha-num+" [octx [pointer! [integer!]]] 
            f_ctx||382~parse-url: "f_ctx||382~parse-url" [octx [pointer! [integer!]]] 
            f_decode-url: "f_decode-url" [octx [pointer! [integer!]]] 
            f_encode-url: "f_encode-url" [octx [pointer! [integer!]]] 
            f_ctx||388~do-quit: "f_ctx||388~do-quit" [octx [pointer! [integer!]]] 
            f_ctx||388~throw-error: "f_ctx||388~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||388~syntax-error: "f_ctx||388~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx||388~do-safe: "f_ctx||388~do-safe" [octx [pointer! [integer!]]] 
            f_ctx||388~do-code: "f_ctx||388~do-code" [octx [pointer! [integer!]]] 
            f_ctx||388~count-args: "f_ctx||388~count-args" [octx [pointer! [integer!]]] 
            f_ctx||388~arg-mode?: "f_ctx||388~arg-mode?" [octx [pointer! [integer!]]] 
            f_ctx||388~func-arity?: "f_ctx||388~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx||388~value-path?: "f_ctx||388~value-path?" [octx [pointer! [integer!]]] 
            f_ctx||388~fetch-next: "f_ctx||388~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx||388~eval: "f_ctx||388~eval" [octx [pointer! [integer!]]] 
            f_ctx||388~do-macro: "f_ctx||388~do-macro" [octx [pointer! [integer!]]] 
            f_ctx||388~register-macro: "f_ctx||388~register-macro" [octx [pointer! [integer!]]] 
            f_ctx||388~reset: "f_ctx||388~reset" [octx [pointer! [integer!]]] 
            f_ctx||388~expand: "f_ctx||388~expand" [octx [pointer! [integer!]]] 
            ...
            f_ctx||424~tail-idx?: "f_ctx||424~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx||424~push-color: "f_ctx||424~push-color" [octx [pointer! [integer!]]] 
            f_ctx||424~pop-color: "f_ctx||424~pop-color" [octx [pointer! [integer!]]] 
            f_ctx||424~close-colors: "f_ctx||424~close-colors" [octx [pointer! [integer!]]] 
            f_ctx||424~push: "f_ctx||424~push" [octx [pointer! [integer!]]] 
            f_ctx||424~pop: "f_ctx||424~pop" [octx [pointer! [integer!]]] 
            f_ctx||424~pop-all: "f_ctx||424~pop-all" [octx [pointer! [integer!]]] 
            f_ctx||424~optimize: "f_ctx||424~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx||422~line-height?: "f_ctx||422~line-height?" [octx [pointer! [integer!]]] 
            f_ctx||422~line-count?: "f_ctx||422~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx||444~on-change*: "f_ctx||444~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||444~on-deep-change*: "f_ctx||444~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||448~on-change*: "f_ctx||448~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||448~on-deep-change*: "f_ctx||448~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||452~on-change*: "f_ctx||452~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||455~on-change*: "f_ctx||455~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||458~capture-events: "f_ctx||458~capture-events" [octx [pointer! [integer!]]] 
            f_ctx||458~awake: "f_ctx||458~awake" [octx [pointer! [integer!]]] 
            f_ctx||467~init: "f_ctx||467~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx||477~title-ize: "f_ctx||477~title-ize" [octx [pointer! [integer!]]] 
            f_ctx||477~sentence-ize: "f_ctx||477~sentence-ize" [octx [pointer! [integer!]]] 
            f_ctx||477~capitalize: "f_ctx||477~capitalize" [octx [pointer! [integer!]]] 
            f_ctx||477~adjust-buttons: "f_ctx||477~adjust-buttons" [octx [pointer! [integer!]]] 
            f_ctx||477~Cancel-OK: "f_ctx||477~Cancel-OK" [octx [pointer! [integer!]]] 
            f_ctx||475~process: "f_ctx||475~process" [octx [pointer! [integer!]]] 
            f_ctx||473~throw-error: "f_ctx||473~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||473~process-reactors: "f_ctx||473~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx||473~calc-size: "f_ctx||473~calc-size" [octx [pointer! [integer!]]] 
            f_ctx||473~align-faces: "f_ctx||473~align-faces" [octx [pointer! [integer!]]] 
            f_ctx||473~resize-child-panels: "f_ctx||473~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx||473~clean-style: "f_ctx||473~clean-style" [octx [pointer! [integer!]]] 
            f_ctx||473~process-draw: "f_ctx||473~process-draw" [octx [pointer! [integer!]]] 
            f_ctx||473~pre-load: "f_ctx||473~pre-load" [octx [pointer! [integer!]]] 
            f_ctx||473~add-option: "f_ctx||473~add-option" [octx [pointer! [integer!]]] 
            f_ctx||473~add-flag: "f_ctx||473~add-flag" [octx [pointer! [integer!]]] 
            f_ctx||473~fetch-value: "f_ctx||473~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx||473~fetch-argument: "f_ctx||473~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx||473~fetch-expr: "f_ctx||473~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx||473~fetch-options: "f_ctx||473~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx||473~make-actor: "f_ctx||473~make-actor" [octx [pointer! [integer!]]] 
            ...
            ctx||296~encode: "ctx||296~encode" [img [red-image!] where [cell!]] 
            ctx||296~decode: "ctx||296~decode" [data [cell!]] 
            ctx||300~encode: "ctx||300~encode" [img [red-image!] where [cell!]] 
            ctx||300~decode: "ctx||300~decode" [data [cell!]] 
            ctx||304~encode: "ctx||304~encode" [img [red-image!] where [cell!]] 
            ctx||304~decode: "ctx||304~decode" [data [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx||467~make-null-handle: "ctx||467~make-null-handle" [] 
            ctx||467~get-screen-size: "ctx||467~get-screen-size" [id [integer!]] 
            ctx||467~size-text: "ctx||467~size-text" [face [red-object!] value [cell!]] 
            ctx||467~on-change-facet: "ctx||467~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx||467~update-font: "ctx||467~update-font" [font [red-object!] flags [integer!]] 
            ctx||467~update-para: "ctx||467~update-para" [face [red-object!] flags [integer!]] 
            ctx||467~destroy-view: "ctx||467~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx||467~update-view: "ctx||467~update-view" [face [red-object!]] 
            ctx||467~refresh-window: "ctx||467~refresh-window" [h [red-handle!]] 
            ctx||467~redraw: "ctx||467~redraw" [face [red-object!]] 
            ctx||467~show-window: "ctx||467~show-window" [id [red-handle!]] 
            ctx||467~make-view: "ctx||467~make-view" [face [red-object!] parent [red-handle!]] 
            ctx||467~draw-image: "ctx||467~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx||467~draw-face: "ctx||467~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx||467~do-event-loop: "ctx||467~do-event-loop" [no-wait? [logic!]] 
            ctx||467~exit-event-loop: "ctx||467~exit-event-loop" [] 
            ctx||467~request-font: "ctx||467~request-font" [font [red-object!] selected [red-object!] mono? [logic!]] 
            ctx||467~request-file: "ctx||467~request-file" [title [red-string!] name [red-file!] filter [red-block!] save? [logic!] multi? [logic!]] 
            ctx||467~request-dir: "ctx||467~request-dir" [title [red-string!] dir [red-file!] filter [red-block!] keep? [logic!] multi? [logic!]] 
            ctx||467~text-box-metrics: "ctx||467~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx||467~update-scroller: "ctx||467~update-scroller" [scroller [red-object!] flags [integer!]] 
            ...
            alloc-at-tail: "red/alloc-at-tail" [blk [red-block!] return: [cell!]] 
    ...
    percent: context [
        #import [libRedRT-file stdcall [
                ...
                rs-make-at: "red/percent/rs-make-at" [slot [cell!] value [float!] return: [red-float!]]
            ]]
    ] 
    ref: context [
        #import [libRedRT-file stdcall [
    ...
    unicode: context [
        #import [libRedRT-file stdcall [
                ...
                get-cache: "red/unicode/get-cache" [str [red-string!] size [integer!] return: [c-string!]] 
                load-utf16: "red/unicode/load-utf16" [src [c-string!] size [integer!] str [red-string!] cr? [logic!] return: [pointer! [integer!]]]
            ]]
    ] 
    natives: context [
        #import [libRedRT-file stdcall [
    ...
    OS-image: context [
        #import [libRedRT-file stdcall [
                to-cgimage: "red/OS-image/to-cgimage" [img [red-image!] return: [integer!]] 
                delete: "red/OS-image/delete" [img [red-image!]] 
                get-pixel: "red/OS-image/get-pixel" [bitmap [pointer! [integer!]] index [integer!] return: [integer!]] 
                load-nsdata: "red/OS-image/load-nsdata" [data [pointer! [integer!]] return: [pointer! [integer!]]] 
                load-cgimage: "red/OS-image/load-cgimage" [h [pointer! [integer!]] return: [pointer! [integer!]]] 
                combine-image: "red/OS-image/combine-image" [img1 [integer!] img2 [integer!] mode [integer!] return: [integer!]] 
                to-bitmap-ctx: "red/OS-image/to-bitmap-ctx" [img [integer!] return: [pointer! [integer!]]] 
                ctx-to-image: "red/OS-image/ctx-to-image" [img [red-image!] ctx [integer!]]
            ]]
    ] 
    ownership: context [
        #import [libRedRT-file stdcall [
