...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_ctx||365~on-change*: "f_ctx||365~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||368~on-change*: "f_ctx||368~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||368~on-deep-change*: "f_ctx||368~on-deep-change*" [octx [pointer! [integer!]]] 
            f_reactor: "f_reactor" [] 
            f_deep-reactor: "f_deep-reactor" [] 
            f_ctx||373~add-relation: "f_ctx||373~add-relation" [octx [pointer! [integer!]]] 
            f_ctx||373~eval: "f_ctx||373~eval" [octx [pointer! [integer!]]] 
            f_ctx||373~eval-reaction: "f_ctx||373~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx||373~pending?: "f_ctx||373~pending?" [octx [pointer! [integer!]]] 
            f_ctx||373~check: "f_ctx||373~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx||373~is~: "f_ctx||373~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_register-scheme: "f_register-scheme" [] 
            f_ctx||388~alpha-num+: "f_ctx||388~alpha-num+" [octx [pointer! [integer!]]] 
            f_ctx||388~parse-url: "f_ctx||388~parse-url" [octx [pointer! [integer!]]] 
            f_decode-url: "f_decode-url" [octx [pointer! [integer!]]] 
            f_encode-url: "f_encode-url" [octx [pointer! [integer!]]] 
            f_ctx||394~do-quit: "f_ctx||394~do-quit" [octx [pointer! [integer!]]] 
            f_ctx||394~throw-error: "f_ctx||394~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||394~syntax-error: "f_ctx||394~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx||394~do-safe: "f_ctx||394~do-safe" [octx [pointer! [integer!]]] 
            f_ctx||394~do-code: "f_ctx||394~do-code" [octx [pointer! [integer!]]] 
            f_ctx||394~count-args: "f_ctx||394~count-args" [octx [pointer! [integer!]]] 
            f_ctx||394~arg-mode?: "f_ctx||394~arg-mode?" [octx [pointer! [integer!]]] 
            f_ctx||394~func-arity?: "f_ctx||394~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx||394~value-path?: "f_ctx||394~value-path?" [octx [pointer! [integer!]]] 
            f_ctx||394~fetch-next: "f_ctx||394~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx||394~eval: "f_ctx||394~eval" [octx [pointer! [integer!]]] 
            f_ctx||394~do-macro: "f_ctx||394~do-macro" [octx [pointer! [integer!]]] 
            f_ctx||394~register-macro: "f_ctx||394~register-macro" [octx [pointer! [integer!]]] 
            f_ctx||394~reset: "f_ctx||394~reset" [octx [pointer! [integer!]]] 
            f_ctx||394~expand: "f_ctx||394~expand" [octx [pointer! [integer!]]] 
            ...
            f_ctx||430~tail-idx?: "f_ctx||430~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx||430~push-color: "f_ctx||430~push-color" [octx [pointer! [integer!]]] 
            f_ctx||430~pop-color: "f_ctx||430~pop-color" [octx [pointer! [integer!]]] 
            f_ctx||430~close-colors: "f_ctx||430~close-colors" [octx [pointer! [integer!]]] 
            f_ctx||430~push: "f_ctx||430~push" [octx [pointer! [integer!]]] 
            f_ctx||430~pop: "f_ctx||430~pop" [octx [pointer! [integer!]]] 
            f_ctx||430~pop-all: "f_ctx||430~pop-all" [octx [pointer! [integer!]]] 
            f_ctx||430~optimize: "f_ctx||430~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx||428~line-height?: "f_ctx||428~line-height?" [octx [pointer! [integer!]]] 
            f_ctx||428~line-count?: "f_ctx||428~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx||464~capture-events: "f_ctx||464~capture-events" [octx [pointer! [integer!]]] 
            f_ctx||464~awake: "f_ctx||464~awake" [octx [pointer! [integer!]]] 
            f_ctx||473~init: "f_ctx||473~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx||483~title-ize: "f_ctx||483~title-ize" [octx [pointer! [integer!]]] 
            f_ctx||483~sentence-ize: "f_ctx||483~sentence-ize" [octx [pointer! [integer!]]] 
            f_ctx||483~capitalize: "f_ctx||483~capitalize" [octx [pointer! [integer!]]] 
            f_ctx||483~adjust-buttons: "f_ctx||483~adjust-buttons" [octx [pointer! [integer!]]] 
            f_ctx||483~Cancel-OK: "f_ctx||483~Cancel-OK" [octx [pointer! [integer!]]] 
            ...
            ctx||362~encode: "ctx||362~encode" [data [cell!] where [cell!]] 
            ctx||362~decode: "ctx||362~decode" [payload [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx||473~make-null-handle: "ctx||473~make-null-handle" [] 
            ctx||473~get-screen-size: "ctx||473~get-screen-size" [id [integer!]] 
            ctx||473~size-text: "ctx||473~size-text" [face [red-object!] value [cell!]] 
            ctx||473~on-change-facet: "ctx||473~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx||473~update-font: "ctx||473~update-font" [font [red-object!] flags [integer!]] 
            ctx||473~update-para: "ctx||473~update-para" [face [red-object!] flags [integer!]] 
            ctx||473~destroy-view: "ctx||473~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx||473~update-view: "ctx||473~update-view" [face [red-object!]] 
            ctx||473~refresh-window: "ctx||473~refresh-window" [h [red-handle!]] 
            ctx||473~redraw: "ctx||473~redraw" [face [red-object!]] 
            ctx||473~show-window: "ctx||473~show-window" [id [red-handle!]] 
            ctx||473~make-view: "ctx||473~make-view" [face [red-object!] parent [red-handle!]] 
            ctx||473~draw-image: "ctx||473~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx||473~draw-face: "ctx||473~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx||473~do-event-loop: "ctx||473~do-event-loop" [no-wait? [logic!]] 
            ctx||473~exit-event-loop: "ctx||473~exit-event-loop" [] 
            ctx||473~request-font: "ctx||473~request-font" [font [red-object!] selected [red-object!] mono? [logic!]] 
            ctx||473~request-file: "ctx||473~request-file" [title [red-string!] name [red-file!] filter [red-block!] save? [logic!] multi? [logic!]] 
            ctx||473~request-dir: "ctx||473~request-dir" [title [red-string!] dir [red-file!] filter [red-block!] keep? [logic!] multi? [logic!]] 
            ctx||473~text-box-metrics: "ctx||473~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx||473~update-scroller: "ctx||473~update-scroller" [scroller [red-object!] flags [integer!]] 
